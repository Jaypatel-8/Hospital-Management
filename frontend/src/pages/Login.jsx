...
return  <section className="px-5 lg:px-0">
    <div className="-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10">
        <h3 className="text-headingCollor text-[22px] leading-9 font-bold mb-10">
          Hello
        <span className="text-primaryColor" > Welcome </span>
        Back
        </h3>
        <form className="py-4 md:py-6">
          <div className="mb-5">
          ...
          <p className="mt-5 text-textColor text-center">
            Dont't have an Account? <Link to='/register' className='text-primaryColor font-bold '>Register</Link>
          </p>
